...
#define CLOWNMDEMU_FM_SAMELE_RATE_DIVIDER (6 * 6 * 4)
#define CLOWNMDEMU_FM_SAMPLE_RATE_NTSC (CLOWNMDEMU_M68K_CLOCK_NTSC / CLOWNMDEMU_FM_SAMELE_RATE_DIVIDER)
#define CLOWNMDEMU_FM_SAMPLE_RATE_PAL  (CLOWNMDEMU_M68K_CLOCK_PAL / CLOWNMDEMU_FM_SAMELE_RATE_DIVIDER)
